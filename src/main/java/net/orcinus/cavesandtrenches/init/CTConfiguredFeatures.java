...
//    public static final Holder<ConfiguredFeature<?, ?>> LUMIERE_CRYSTALS = registerConfiguredFeature("lumiere_crystals", Feature.RANDOM_BOOLEAN_SELECTOR, new RandomBooleanFeatureConfiguration(LUMIERE_CRYSTAL_CEILING::placed, LUMIERE_CRYSTAL_FLOOR::placed)));
    public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> MYSTERIA_TREE = registerConfiguredFeature("mysteria_tree", CTFeatures.MYSTERIA_TREE.get());
    ...
    public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> STIFFINED_ROOF = registerConfiguredFeature("stiffined_roof", CTFeatures.STIFFENED_ROOTS.get());
    public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> FLUTTERED_LEAF = registerConfiguredFeature("fluttered_leaf", CTFeatures.FLUTTERED_LEAF.get());
