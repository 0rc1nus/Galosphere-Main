...
public class CTPlacedFeatures {
    ...
    public static final PlacedFeature LARGE_ALLURITE_CRYSTALS = registerPlacedFeature("large_allurite_crystals", CTConfiguredFeatures.LARGE_ALLURITE_CRYSTALS.placed(CountPlacement.of(UniformInt.of(256, 324)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome()));
    public static final PlacedFeature LARGE_LUMIERE_CRYSTALS = registerPlacedFeature("large_lumiere_crystals", CTConfiguredFeatures.LARGE_LUMIERE_CRYSTALS.placed(CountPlacement.of(UniformInt.of(256, 324)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome()));
