...
//        consumer.accept(Pair.of(Climate.parameters(Climate.Parameter.span(0.8F, 1.0F), FULL_RANGE, FULL_RANGE, FULL_RANGE, CAVE_BIOME_RANGE, Climate.Parameter.span(-1.0F, 0.0F), 0.0F), CRYSTAL_CANYONS));
        consumer.accept(Pair.of(Climate.parameters(FULL_RANGE, Climate.Parameter.span(0.4F, 1.0F), Climate.Parameter.span(0.4F, 0.45F), FULL_RANGE, CAVE_BIOME_RANGE, FULL_RANGE, 0.0F), CRYSTAL_CANYONS));
    }
