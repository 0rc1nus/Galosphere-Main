...
public class CTHorseArmorItem extends HorseArmorItem {
    ...
    public CTHorseArmorItem(int protection, String name) {
        super(protection, new ResourceLocation(Galosphere.MODID, "textures/entity/horse/armor/horse_armor_" + name + ".png"), new Item.Properties().stacksTo(1).tab(Galosphere.CAVESANDTRENCHES));
    }
