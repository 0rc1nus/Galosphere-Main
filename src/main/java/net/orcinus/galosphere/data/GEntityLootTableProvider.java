...
public class GEntityLootTableProvider extends SimpleFabricLootTableProvider {
    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> biConsumer) {
        ...
        biConsumer.accept(GEntityTypes.BERSERKER.getDefaultLootTable(), LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(GItems.PRESERVING_TEMPLATE))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(GItems.PRESERVED_FLESH))));
    }
