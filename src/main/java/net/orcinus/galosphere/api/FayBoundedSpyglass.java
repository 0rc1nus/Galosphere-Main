...
public interface FayBoundedSpyglass {
    ...
    static boolean canUseFayBoundedSpyglass(ItemStack stack, LivingEntity livingEntity) {
        return stack.is(GItems.SPECTRE_BOUNDED_SPYGLASS.get()) && FayBoundedSpyglass.isFayBoundedSpyglass(stack) && !(livingEntity.getDeltaMovement().horizontalDistanceSqr() > 1.0E-6);
    }
