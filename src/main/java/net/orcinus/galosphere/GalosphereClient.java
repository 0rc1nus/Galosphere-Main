...
import net.orcinus.galosphere.mixin.ItemPropertiesAccessor;
...
public class GalosphereClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ItemPropertiesAccessor.callRegister(Items.CROSSBOW, new ResourceLocation(Galosphere.MODID, "glow_flare"), (stack, world, entity, p_174608_) -> entity != null && CrossbowItem.isCharged(stack) && CrossbowItem.containsChargedProjectile(stack, GItems.GLOW_FLARE) ? 1.0F : 0.0F);
