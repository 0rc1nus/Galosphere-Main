...
import net.orcinus.galosphere.client.animations.BlightedAnimations;
import net.orcinus.galosphere.entities.Blighted;

@Environment(EnvType.CLIENT)
public class BlightedModel<T extends Blighted> extends HierarchicalModel<T> {
    private final ModelPart root;

    public BlightedModel(ModelPart root) {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(BlightedAnimations.BLIGHTED_WALK, limbSwing, limbSwingAmount, 3.0F, 4.5F);
        this.animate(entity.attackAnimationState, BlightedAnimations.BLIGHTED_ATTACK, ageInTicks, 1.0F);
        this.animate(entity.undermineAnimationState, BlightedAnimations.BLIGHTED_SMASH, ageInTicks, 1.0F);
        this.animate(entity.roarAnimationState, BlightedAnimations.BLIGHTED_IDLE, ageInTicks, 1.0F);
    }
