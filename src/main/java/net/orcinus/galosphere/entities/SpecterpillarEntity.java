...
public class SpecterpillarEntity extends PathfinderMob {
    protected static final ImmutableList<SensorType<? extends Sensor<? super SpecterpillarEntity>>> SENSOR_TYPES = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_PLAYERS, SensorType.HURT_BY, GSensorTypes.SPECTRE_TEMPTATIONS.get(), GSensorTypes.NEAREST_LICHEN_MOSS.get());
