...
public class SmoothSwimmingLandControl extends MoveControl {
    private final SparkleEntity entity;
    private final float speedMultiplier;
    private final float ySpeedModifier;

    public SmoothSwimmingLandControl(SparkleEntity entity, float speedMultiplier, float ySpeedModifier) {
        super(entity);
        this.entity = entity;
