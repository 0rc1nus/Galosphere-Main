...
public class Berserker extends Monster {
    ...
    protected SoundEvent getAmbientSound() {
        return GSoundEvents.BERSERKER_IDLE;
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Berserker.createMonsterAttributes().add(Attributes.MAX_HEALTH, 200.0).add(Attributes.MOVEMENT_SPEED, 0.3F).add(Attributes.ATTACK_DAMAGE, 15.0D).add(Attributes.KNOCKBACK_RESISTANCE, 1.0D).add(Attributes.ATTACK_KNOCKBACK, 1.5D);
    }
