...
public class GPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> ORE_SILVER_SMALL = registerPlacedFeature("ore_silver_small", GConfiguredFeatures.ORE_SILVER_SMALL, commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(48))));
    ...
    public static final Holder<PlacedFeature> GRAVEL_PATCH = registerPlacedFeature("gravel_patch", GConfiguredFeatures.GRAVEL_PATCH, CountPlacement.of(20), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome());
    ...
    public static final Holder<PlacedFeature> ORE_SILVER_LARGE = registerPlacedFeature("ore_silver_large", GConfiguredFeatures.ORE_SILVER_LARGE, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112))));
