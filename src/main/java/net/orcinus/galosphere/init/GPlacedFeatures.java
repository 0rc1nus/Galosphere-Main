...
public class GPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> SURFACE_OASIS = registerPlacedFeature("surface_oasis");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> bootstapContext) {
        ...
        PlacementUtils.register(bootstapContext, SURFACE_OASIS, holderGetter.getOrThrow(GConfiguredFeatures.SURFACE_OASIS), CountPlacement.of(UniformInt.of(1, 2)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(-1)), BiomeFilter.biome());
    }
