...
public class GBlocks {
    ...
    public static final RegistryObject<Block> COMBUSTION_TABLE = registerBlock("combustion_table", () -> new CombustionTableBlock(BlockBehaviour.Properties.of().strength(2.5F).sound(GSoundEvents.COMBUSTION_TABLE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> LICHEN_ROOTS = registerBlock("lichen_roots", () -> new LichenRootsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_CYAN).replaceable().noCollission().instabreak().offsetType(BlockBehaviour.OffsetType.XZ).sound(GSoundEvents.LICHEN_ROOTS)));
    ...
    public static final RegistryObject<Block> LICHEN_SHELF = registerBlock("lichen_shelf", () -> new BaseCoralWallFanBlock(BlockBehaviour.Properties.copy(Blocks.BRAIN_CORAL_FAN).noCollission().sound(GSoundEvents.LICHEN_SHELF)));
    ...
    public static final RegistryObject<Block> PINK_SALT = registerBlock("pink_salt", () -> new PinkSaltBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> ROSE_PINK_SALT = registerBlock("rose_pink_salt", () -> new PinkSaltBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> PASTEL_PINK_SALT = registerBlock("pastel_pink_salt", () -> new PinkSaltBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> PINK_SALT_STAIRS = registerBlock("pink_salt_stairs", () -> new PinkSaltStairsBlock(PINK_SALT.get().defaultBlockState(), BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> ROSE_PINK_SALT_STAIRS = registerBlock("rose_pink_salt_stairs", () -> new PinkSaltStairsBlock(ROSE_PINK_SALT.get().defaultBlockState(), BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> PASTEL_PINK_SALT_STAIRS = registerBlock("pastel_pink_salt_stairs", () -> new PinkSaltStairsBlock(PASTEL_PINK_SALT.get().defaultBlockState(), BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> PINK_SALT_SLAB = registerBlock("pink_salt_slab", () -> new PinkSaltSlabBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> ROSE_PINK_SALT_SLAB = registerBlock("rose_pink_salt_slab", () -> new PinkSaltSlabBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> PASTEL_PINK_SALT_SLAB = registerBlock("pastel_pink_salt_slab", () -> new PinkSaltSlabBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> PINK_SALT_WALL = registerBlock("pink_salt_wall", () -> new PinkSaltWallBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> ROSE_PINK_SALT_WALL = registerBlock("rose_pink_salt_wall", () -> new PinkSaltWallBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> PASTEL_PINK_SALT_WALL = registerBlock("pastel_pink_salt_wall", () -> new PinkSaltWallBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> POLISHED_PINK_SALT = registerBlock("polished_pink_salt", () -> new PinkSaltBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> POLISHED_ROSE_PINK_SALT = registerBlock("polished_rose_pink_salt", () -> new PinkSaltBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> POLISHED_PASTEL_PINK_SALT = registerBlock("polished_pastel_pink_salt", () -> new PinkSaltBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> POLISHED_PINK_SALT_STAIRS = registerBlock("polished_pink_salt_stairs", () -> new PinkSaltStairsBlock(PINK_SALT.get().defaultBlockState(), BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> POLISHED_ROSE_PINK_SALT_STAIRS = registerBlock("polished_rose_pink_salt_stairs", () -> new PinkSaltStairsBlock(ROSE_PINK_SALT.get().defaultBlockState(), BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> POLISHED_PASTEL_PINK_SALT_STAIRS = registerBlock("polished_pastel_pink_salt_stairs", () -> new PinkSaltStairsBlock(PASTEL_PINK_SALT.get().defaultBlockState(), BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> POLISHED_PINK_SALT_SLAB = registerBlock("polished_pink_salt_slab", () -> new PinkSaltSlabBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> POLISHED_ROSE_PINK_SALT_SLAB = registerBlock("polished_rose_pink_salt_slab", () -> new PinkSaltSlabBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> POLISHED_PASTEL_PINK_SALT_SLAB = registerBlock("polished_pastel_pink_salt_slab", () -> new PinkSaltSlabBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> POLISHED_PINK_SALT_WALL = registerBlock("polished_pink_salt_wall", () -> new PinkSaltWallBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> POLISHED_ROSE_PINK_SALT_WALL = registerBlock("polished_rose_pink_salt_wall", () -> new PinkSaltWallBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> POLISHED_PASTEL_PINK_SALT_WALL = registerBlock("polished_pastel_pink_salt_wall", () -> new PinkSaltWallBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> PINK_SALT_BRICKS = registerBlock("pink_salt_bricks", () -> new PinkSaltBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> ROSE_PINK_SALT_BRICKS = registerBlock("rose_pink_salt_bricks", () -> new PinkSaltBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> PASTEL_PINK_SALT_BRICKS = registerBlock("pastel_pink_salt_bricks", () -> new PinkSaltBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> PINK_SALT_BRICK_STAIRS = registerBlock("pink_salt_brick_stairs", () -> new PinkSaltStairsBlock(PINK_SALT.get().defaultBlockState(), BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> ROSE_PINK_SALT_BRICK_STAIRS = registerBlock("rose_pink_salt_brick_stairs", () -> new PinkSaltStairsBlock(ROSE_PINK_SALT.get().defaultBlockState(), BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> PASTEL_PINK_SALT_BRICK_STAIRS = registerBlock("pastel_pink_salt_brick_stairs", () -> new PinkSaltStairsBlock(PASTEL_PINK_SALT.get().defaultBlockState(), BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> PINK_SALT_BRICK_SLAB = registerBlock("pink_salt_brick_slab", () -> new PinkSaltSlabBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> ROSE_PINK_SALT_BRICK_SLAB = registerBlock("rose_pink_salt_brick_slab", () -> new PinkSaltSlabBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
    public static final RegistryObject<Block> PASTEL_PINK_SALT_BRICK_SLAB = registerBlock("pastel_pink_salt_brick_slab", () -> new PinkSaltSlabBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));

    public static final RegistryObject<Block> PINK_SALT_BRICK_WALL = registerBlock("pink_salt_brick_wall", () -> new PinkSaltWallBlock(BlockBehaviour.Properties.of().sound(GSoundEvents.PINK_SALT).requiresCorrectToolForDrops().strength(0.75f)));
