...
public class GBlocks {
    ...
    public static final RegistryObject<Block> AURA_RINGER = registerBlock("aura_ringer", () -> new AuraRingerBlock(BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.COLOR_CYAN).lightLevel(state -> ((AuraRingerBlock)state.getBlock()).isRinging(state) ? 10 : 0).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundType.METAL)));
