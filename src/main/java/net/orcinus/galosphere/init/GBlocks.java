...
public class GBlocks {
    ...
    public static final RegistryObject<Block> LUMIERE_BLOCK = registerBlock("lumiere_block", () -> new LumiereBlock(false, BlockBehaviour.Properties.copy(Blocks.AMETHYST_BLOCK).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> AURA_RINGER = registerBlock("aura_ringer", () -> new AuraRingerBlock(BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.COLOR_CYAN).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundType.METAL)));
