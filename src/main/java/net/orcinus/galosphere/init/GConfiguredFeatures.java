...
public class GConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> BOWL_LICHEN = registerConfiguredFeature("lichen_mushroom", GFeatures.BOWL_LICHEN.get(), FeatureConfiguration.NONE);
    public static final Holder<ConfiguredFeature<SimpleBlockConfiguration, ?>> LICHEN_VEGETATION = registerConfiguredFeature("lichen_vegetation", Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(GBlocks.BOWL_LICHEN.get().defaultBlockState(), 4).add(Blocks.GLOW_LICHEN.defaultBlockState().setValue(MultifaceBlock.getFaceProperty(Direction.DOWN), true), 2).add(GBlocks.LICHEN_ROOTS.get().defaultBlockState(), 50).add(Blocks.AIR.defaultBlockState(), 10))));
    public static final Holder<ConfiguredFeature<VegetationPatchConfiguration, ?>> LICHEN_PATCH = registerConfiguredFeature("lichen_patch", GFeatures.LICHEN_PATCH.get(), new VegetationPatchConfiguration(BlockTags.MOSS_REPLACEABLE, BlockStateProvider.simple(GBlocks.LICHEN_MOSS.get()), PlacementUtils.inlinePlaced(LICHEN_VEGETATION), CaveSurface.FLOOR, ConstantInt.of(1), 0.0F, 5, 0.8F, UniformInt.of(4, 7), 0.3F));
    public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> LICHEN_CORDYCEPS = registerConfiguredFeature("lichen_cordyceps", GFeatures.LICHEN_CORDYCEPS_COLUMN.get(), new NoneFeatureConfiguration());
