...
public class GConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> MYSTERIA_TREE = registerConfiguredFeature("mysteria_tree", GFeatures.MYSTERIA_TREE.get(), FeatureConfiguration.NONE);
