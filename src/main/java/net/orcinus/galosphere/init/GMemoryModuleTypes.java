...
public class GMemoryModuleTypes {
    ...
    public static final RegistryObject<MemoryModuleType<Integer>> POLLINATED_COOLDOWN = MEMORY_MODULE_TYPES.register("pollinated_cooldown", () -> new MemoryModuleType<>(Optional.of(Codec.INT)));
