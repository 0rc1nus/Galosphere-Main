...
import net.orcinus.galosphere.items.PixieBottleItem;
...
public class GItems {
    ...
    public static final RegistryObject<Item> FAY_SPAWN_EGG = ITEMS.register("fay_spawn_egg", () -> new ForgeSpawnEggItem(GEntityTypes.FAY, 16777215, 10803902, new Item.Properties().tab(Galosphere.GALOSPHERE)));
