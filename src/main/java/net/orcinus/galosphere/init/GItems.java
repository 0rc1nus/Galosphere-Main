...
public class GItems {
    ...
    public static final Item STERLING_HELMET = register("sterling_helmet", new SterlingArmorItem(EquipmentSlot.HEAD, new Item.Properties().stacksTo(1)));
    public static final Item STERLING_CHESTPLATE = register("sterling_chestplate", new SterlingArmorItem(EquipmentSlot.CHEST, new Item.Properties().stacksTo(1)));
    public static final Item STERLING_LEGGINGS = register("sterling_leggings", new SterlingArmorItem(EquipmentSlot.LEGS, new Item.Properties().stacksTo(1)));
    public static final Item STERLING_BOOTS = register("sterling_boots", new SterlingArmorItem(EquipmentSlot.FEET, new Item.Properties().stacksTo(1)));
    public static final Item STERLING_HORSE_ARMOR = register("sterling_horse_armor", new GHorseArmorItem(4, "sterling"));
    public static final Item SPARKLE_SPAWN_EGG = register("sparkle_spawn_egg", new SpawnEggItem(GEntityTypes.SPARKLE, 16777215, 2422488, new Item.Properties()));
    public static final Item SPECTRE_SPAWN_EGG = register("spectre_spawn_egg", new SpawnEggItem(GEntityTypes.SPECTRE, 16777215, 10803902, new Item.Properties()));
    public static final Item ICON_ITEM = register("icon_item", new IconItem(new Item.Properties().stacksTo(0)));
    public static final Item BOTTLE_OF_SPECTRE = register("bottle_of_spectre", new SpectreBottleItem(new Item.Properties().stacksTo(16)));
    ...
    public static void init() {
        for (ResourceLocation id : ITEMS.keySet()) {
            Registry.register(BuiltInRegistries.ITEM, id, ITEMS.get(id));
        }
    }
