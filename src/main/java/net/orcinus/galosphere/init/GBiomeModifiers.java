...
public class GBiomeModifiers {
    ...
    public static final RegistryObject<Codec<? extends BiomeModifier>> GALOSPHERE_BIOME_MODIFIER = BIOME_MODIFIERS.register("galosphere_biome_modifier", () -> Codec.unit(GalosphereBiomeModifier::new));
