...
import net.orcinus.galosphere.entities.ai.sensors.ElementalEntitySensor;
...
public class GSensorTypes {
    ...
    public static final SensorType<ElementalEntitySensor> ELEMENTAL_ENTITY_SENSOR = register("elemental_entity_sensor", ElementalEntitySensor::new);
