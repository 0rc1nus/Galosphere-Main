...
public class GEntityTypes {
    ...
    public static final EntityType<SpectreEntity> SPECTRE = register("spectre", EntityType.Builder.of(SpectreEntity::new, MobCategory.UNDERGROUND_WATER_CREATURE).sized(0.35F, 0.35F).clientTrackingRange(8).updateInterval(2).build(Galosphere.id("fay").toString()));
