...
public class GEntityTypes {
    ...
    public static final RegistryObject<EntityType<SpectreEntity>> SPECTRE = ENTITY_TYPES.register("spectre", () -> EntityType.Builder.of(SpectreEntity::new, MobCategory.UNDERGROUND_WATER_CREATURE).sized(0.35F, 0.35F).clientTrackingRange(8).updateInterval(2).build(new ResourceLocation(Galosphere.MODID, "spectre").toString()));
