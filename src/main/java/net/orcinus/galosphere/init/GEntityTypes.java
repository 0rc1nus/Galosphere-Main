...
public class GEntityTypes {
    ...
    public static final EntityType<FayEntity> FAY = register("fay", EntityType.Builder.of(FayEntity::new, MobCategory.UNDERGROUND_WATER_CREATURE).sized(0.35F, 0.35F).clientTrackingRange(8).updateInterval(2).build(new ResourceLocation(Galosphere.MODID, "fay").toString()));
