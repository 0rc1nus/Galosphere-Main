...
public class GEntityTypes {
    ...
    public static final EntityType<Spectre> SPECTRE = register("spectre", EntityType.Builder.of(Spectre::new, MobCategory.AMBIENT).sized(0.5F, 0.5F).clientTrackingRange(8).updateInterval(2).build(Galosphere.id("spectre").toString()));
