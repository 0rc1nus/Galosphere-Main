...
public class GEntityTypes {
    ...
    public static final RegistryObject<EntityType<SilverBomb>> SILVER_BOMB = ENTITY_TYPES.register("silver_bomb", () -> EntityType.Builder.<SilverBomb>of(SilverBomb::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(10).build(new ResourceLocation(Galosphere.MODID, "silver_bomb").toString()));
