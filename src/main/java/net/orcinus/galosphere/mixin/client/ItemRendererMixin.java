...
public class ItemRendererMixin {
    ...
    private BakedModel GE$render(BakedModel value, ItemStack itemStack, ItemDisplayContext itemDisplayContext, boolean bl, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j, BakedModel bakedModel) {
