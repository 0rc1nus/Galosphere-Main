...
public class ClientEvents {
    ...
    public static void onClientSetup(final FMLClientSetupEvent event) {
        ...
        ItemBlockRenderTypes.setRenderLayer(GBlocks.GLOW_INK_CLUMPS.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(GBlocks.POTTED_LICHEN_ROOTS.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(GBlocks.POTTED_BOWL_LICHEN.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(GBlocks.CHANDELIER.get(), RenderType.translucent());
        ItemBlockRenderTypes.setRenderLayer(GBlocks.LICHEN_CORDYCEPS.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(GBlocks.LICHEN_CORDYCEPS_PLANT.get(), RenderType.cutout());
